  ...
  return (
    <>
      <div id="footer" className="footer">
        <div className="NSS__logo">
          <img className="NSSlogo__img" src={NSSlogo} alt="C51" />
          <div className="footer-media__icons">
            <div className="icon">
              <a
                href="https://www.linkedin.com/school/nashville-software-school/mycompany/"
                target="_blank"
                rel="noreferrer"
              >
                <BsLinkedin />
            ...
            <div className="icon">
              <a
                href="https://www.facebook.com/NashvilleSoftwareSchool/"
                target="_blank"
                rel="noreferrer"
              >
                <BsFacebook />
            ...
            <div className="icon">
              <a
                href="https://twitter.com/NashSoftware"
                target="_blank"
                rel="noreferrer"
              >
                <BsTwitter />
