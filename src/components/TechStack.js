        ...
        <section id="combined-stack__block">
          ...
          <section id="stacks-by-type__block">
            <section id="front-end-stack__block" className="list__block">
              ...
              <p className="front-end__description">Front-End Devs focused on streamlining web application design and user experience.</p>
              <ul
            ...
            <section id="full-stack__block" className="list__block">
              ...
              <p className="full-stack__description">Full-Stack Devs focused on the backend and functionality of a web application.</p>
